...
var thingSpeakChannels = [{_id:2,apiKey:'4BLDCMJ2KGMKCRGN'},{_id:4,apiKey:'11111'}];
...
// Searches and array of objects for an _id
...
console.log("Got this sensor data from the post" + sensorData);
...
var sendToCloud = function(sensorData){
    ...
    console.log("sensor data now looks like" + sensorData);

    // Get the thing speak api key for this node
    var apiKey = findById(thingSpeakChannels,sensorData.nodeId);
